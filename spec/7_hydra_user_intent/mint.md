...
2. User Intent - Redeemer `MintCancelOrderIntent { account: UserAcount, order_id: ByteArray }`
...
3. User Intent - Redeemer `MintWithdrawalIntent { account: UserAccount, amount: MValue }`
...
4. User Intent - Redeemer `MintCancelWithdrawalIntent { account: UserAccount, amount: MValue }`
...
5. User Intent - Redeemer `MintCancelTransferIntent`
